...
using MyRentalPos.Core.Fakes;
using MyRentalPos.Data;
using MyRentalPos.Infrastructure;
using MyRentalPos.Services.Email;
using MyRentalPos.Services.Logging;
...
namespace MyRentalPos.App_Start
{
    public static class AutofacConfig
    {
        ...
        private static void InitService(ContainerBuilder builder)
        {
            ...
            //builder.RegisterType<EmailSender>().As<IEmailSender>().InstancePerHttpRequest();
            //services
            var assembly = Assembly.Load("MyRentalPos");
